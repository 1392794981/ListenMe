...
public class FileEncodingDetect {
    static FileEncodingDetect Encoding = new FileEncodingDetect();
    ...
    public void initFromFile(File file) {
        currentEncoding = detectEncodingWithString(file);
    }

    public String detectEncodingWithString(File file) {
        return codings[detectEncoding(file)];
    }

    public String convertUTF8(String stringInput) {
        return convertUTF8(currentEncoding, stringInput);
    }

    public String convertUTF8(String code, String stringInput) {
        try {
            return new String(stringInput.getBytes(code), "utf-8");
